...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ecommerce", "root", "$DunH7vz4M");
if(count==0){
...
if(count>0){
PreparedStatement ps=con.prepareStatement("select * from quizinfo where quizname='"+name+"' and qid='"+count+"' ");
